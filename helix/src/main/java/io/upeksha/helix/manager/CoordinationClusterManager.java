 ...
 */
public class CoordinationClusterManager {
    ...
    private String resourceName = "Orchestrator";
    ...
    public void initCluster() {
        ...
        builder.dynamicUpperBound("OFFLINE", "R");
    ...
    public static void main(String args[]) {
        CoordinationClusterManager clusterManager = new CoordinationClusterManager();
